...
from handlers.admin import (
    ...
    admin_conv_handler, handle_referral_settings_input
)
        ...
        if callback_data.startswith("service_") or callback_data.startswith("quick_"):
            try:
                ...
                if service_info:
                    ...
                    buttons.append([InlineKeyboardButton("Custom", callback_data="qty_custom")])
...
def main():
    ...
    # Tutorial system
    dispatcher.add_handler(tutorial_handlers.tutorial_conversation_handler())
    dispatcher.add_handler(CommandHandler("tutorial", tutorial_handlers.tutorial_command))
    dispatcher.add_handler(MessageHandler(Filters.text & ~Filters.command, tutorial_handlers.tutorial_text_handler))
