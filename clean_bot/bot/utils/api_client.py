...
class SMMApiClient:
    def __init__(self):
        # Use the provided API key directly instead of from environment variable
        self.api_key = "b99dd32f1d127d08a863fa1c8c8c7abe"
        
        # Try to detect the correct API URL
        self.api_url = self._detect_api_url()
        
        logger.info(f"API Client initialized with URL: {self.api_url} and real API key")
